...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_HARMFUL_TEXT "обнаружена на локализованных сканерах. Место обнаружения:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_DANGEROUS_TEXT "обнаружена на локализованных сканерах. Место обнаружения:"
