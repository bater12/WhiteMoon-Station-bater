/datum/quirk/item_quirk/family_heirloom
	...
	desc = "Вы являетесь нынешним владельцем семейной реликвии, передаваемой из поколения в поколение. Вы должны ее беречь!"
...
/datum/quirk/item_quirk/family_heirloom/post_add()
	...
	if(!family_heirloom)
		to_chat(quirk_holder, span_boldnotice("Волна экзистенциального ужаса накрывает вас, когда вы понимаете, что ваша драгоценная семейная реликвия пропала. Возможно, Боги проявят милосердие к вашей проклятой душе?"))
		return
