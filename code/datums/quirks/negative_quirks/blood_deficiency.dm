/datum/quirk/blooddeficiency
	name = "Дефицит крови"
	desc = "Ваш организм не может вырабатывать достаточно крови для своего поддержания."
	icon = FA_ICON_TINT
	value = -8
	gain_text = span_danger("Вы чувствуете, как ваши силы постепенно угасают.")
	lose_text = span_notice("Вы снова чувствуете себя бодрым.")
	medical_record_text = "Пациенту требуется регулярное переливание, из-за низкой выработки крови."
	hardcore_value = 8
