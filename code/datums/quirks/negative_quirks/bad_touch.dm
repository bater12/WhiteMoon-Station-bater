/datum/quirk/bad_touch
	name = "Неприкасаемый"
	desc = "Вам не нравятся объятия. Вы бы предпочли, чтобы люди просто оставили вас в покое."
	icon = "tg-bad-touch"
	mob_trait = TRAIT_BADTOUCH
	value = -1
	gain_text = span_danger("Вам просто хочется, чтоб люди вас не трогали.")
	lose_text = span_notice("Вы бы не отказались от крепких объятий.")
	medical_record_text = "Пациент испытывает отвращение к прикосновениям. Возможно, имеет недиагностированную гаптофобию."
