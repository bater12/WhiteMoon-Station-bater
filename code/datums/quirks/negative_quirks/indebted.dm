/datum/quirk/indebted
	name = "Задолженность"
	desc = "Неудачные жизненные решения, медицинские счета, студенческие кредиты, что бы это ни было, вы влезли в долги. Часть всего, что вы получите, пойдет на их погашение."
	icon = FA_ICON_DOLLAR
...
/datum/quirk/indebted/add_unique(client/client_source)
	...
	to_chat(client_source.mob, span_warning("Помните, у вас есть огромный [debt] по кредитам, который нужно выплатить..."))
