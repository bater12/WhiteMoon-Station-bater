/datum/quirk/prosopagnosia
	name = "Прозопагнозия"
	desc = "У вас психическое расстройство, из-за которого вы вообще не можете узнавать лица."
	icon = FA_ICON_USER_SECRET
	value = -4
	medical_record_text = "Пациент страдает прозопагнозией и не может узнавать лица."
	hardcore_value = 5
