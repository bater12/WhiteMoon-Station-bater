...
/datum/round_event/anomaly/anomaly_ectoplasm/announce(fake)
	...
	priority_announce("Паранормальный выброс эктоплазмы [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Оповещение Об Аномалии", ANNOUNCER_ANOMALIES) //SKYRAT EDIT CHANGE - ORIGINAL: priority_announce("Paranormal ectoplasmic outburst detected on [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Anomaly Alert")
