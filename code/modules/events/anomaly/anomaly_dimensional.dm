...
/datum/round_event/anomaly/anomaly_dimensional/announce(fake)
	...
	priority_announce("Пространственная нестабильность [ANOMALY_ANNOUNCE_MEDIUM_TEXT] [impact_area.name].", "Оповещение Об Аномалии", ANNOUNCER_ANOMALIES) //SKYRAT EDIT CHANGE - ORIGINAL: priority_announce("Dimensional instability detected on [ANOMALY_ANNOUNCE_MEDIUM_TEXT] [impact_area.name].", "Anomaly Alert")
