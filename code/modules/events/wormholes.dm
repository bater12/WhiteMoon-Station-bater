...
/datum/round_event/wormholes/announce(fake)
	priority_announce("На станции обнаружены пространственно-временные аномалии. Дополнительные данные отсутствуют", "Оповещение Об Аномалии", ANNOUNCER_SPANOMALIES)
